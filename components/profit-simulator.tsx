    ...
    <Card className="bg-slate-900/50 border-slate-800 p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-xs font-mono text-slate-600 mt-1">
          Hypothetical return over {forecastDays}{" "}
      ...
      <div className="space-y-2">
        <Label
          htmlFor="investment"
          className="text-xs font-mono text-slate-500 uppercase"
        >
          Investment Amount
        </Label>
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-9 h-11 bg-slate-900 border-slate-700 text-slate-50 font-mono text-base"
            placeholder="1000"
            min="0"
            step="100"
          />
      ...
      {/* Results */}
      <div className="rounded-lg bg-slate-800/30 p-4 space-y-4">
        <div>
      ...
      <p className="text-[11px] font-mono text-slate-500 leading-relaxed">
        This is a simulated outcome based on the model’s forecast and does not
